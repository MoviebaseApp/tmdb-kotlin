...
object TmdbUrlBuilder {
     ...
     */
    fun buildUserPage(userId: String) = "${TmdbWebConfig.WEBSITE_BASE_URL}/u/${userId}"

    /**
     * Example: https://www.themoviedb.org/review/63501e9ed363e5007a664110
     */
    fun buildReviewPage(reviewId: Int) = "${TmdbWebConfig.WEBSITE_BASE_URL}/review/${reviewId}"
